...
class partnerTable extends tableManager
{
    static private $table_info = array
        (
            array('column'=>'_id',     'as'=>'partner_id', 'locale'=>null,      'type'=>COMMON, 'input'=>FALSE),
    ...
    static public function getAlias($type = COMMON){
        return parent::getAlias(self::$table_info,array('type'=>$type,'alias'=>A_PARTNER));
    }
    ...
    static public function getLocaleAlias($type = COMMON){
        return parent::getLocaleAlias(self::$table_info,array('type'=>$type,'alias'=>A_PARTNER));
    }
}
?>