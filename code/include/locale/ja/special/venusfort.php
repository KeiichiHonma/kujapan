...
$special_locale = array(
    //seo
    'keyword' => '東京,日本,旅行,買い物,クーポン,割引,割引券,VenusFort,ビーナスフォート,特集',
    'description' => 'ビーナスフォート(VenusFort)はアウトレットも併設しているからお買い物天国。日遊酷棒は日本旅行時の買い物で使える大幅お値引クーポンが99元で取り放題のサイトです。',
    'title' => 'お台場ショッピングモール(VenusFort)の特集 | 日遊酷棒',
    'h1' => 'お台場ショッピングモール(VenusFort)の特集',
