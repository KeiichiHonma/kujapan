...
$special_locale = array(
    //seo
    'keyword' => '東京,日本,旅行,買い物,クーポン,割引,割引券,Dr.Ci:Labo,特集',
    'description' => '皮膚の専門家が作ったメディカルコスメのDr.Ci:Labo。日遊酷棒は日本旅行時の買い物で使える大幅お値引クーポンが99元で取り放題のサイトです。',
    'title' => '日本今一番売れている化粧品Dr.Ci:Laboの特集 | 日遊酷棒',
    'h1' => '日本今一番売れている化粧品Dr.Ci:Laboの特集',
