...
<div id="roof_l_white">
    ...
    <form id="couponForm" name="couponForm" action= "{$smarty.const.KUJAPANURLSSL}/system/news/edit/input/nid/{$nid}" method="post">
    ...
    {/foreach}
    {if $nid}<input type="hidden" name="nid" value="{$nid}" />{/if}
