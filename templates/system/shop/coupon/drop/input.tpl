...
<div id="roof_l_white">
    ...
    <h2 class="h_title">クーポン削除</h2>
    <p class="m_b10">以下の項目を入力して[削除]ボタンをクリックしてください。</p>
    <form id="couponForm" name="couponForm" action= "{$smarty.const.KUJAPANURLSSL}/system/shop/coupon/drop/input/cid/{$cid}" method="post">
