...
<div id="roof_l_white">
    ...
    <h2 class="h_title">店舗簡体字地図画像管理</h2>
    <p class="m_b10">以下の項目を入力して[確認画面へ]ボタンをクリックしてください。<span class="attention">＊</span>の項目は必須となります。</p>
    <form id="couponForm" name="couponForm" action= "{$smarty.const.KUJAPANURLSSL}/system/shop/map/cn/input" method="post" enctype="multipart/form-data">
