...
<div id="roof_l_white">
    ...
    <h2 class="h_title">ロゴ(中)画像管理</h2>
    <form id="couponForm" name="couponForm" action= "{$smarty.const.KUJAPANURLSSL}/system/shop/base/logo_m/input" method="post" enctype="multipart/form-data">
...
{if isset($logo_m)}
        ■現在の写真<br />
        <img alt="" src="/img/logo/{$sid}m.gif" width="165" height="65" />
{/if}
    </div>
