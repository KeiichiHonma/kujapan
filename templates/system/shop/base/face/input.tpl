...
<div id="fbox" class="fbox">
    ...
    <div style="float:left;">
185px-140px
{if isset($shop_face.0.path)}
        ■現在の写真<br />
        <img src="{$shop_face.0.path}" width="{$shop_face.0.col_width}" height="{$shop_face.0.col_height}" alt="" />
        <input type="hidden" name="fid" value="{$shop_face.0._id}">
{/if}
    </div>
