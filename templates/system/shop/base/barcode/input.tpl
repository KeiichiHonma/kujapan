...
<div id="roof_l_white">
    ...
    <h2 class="h_title">店舗バーコード画像管理</h2>
    <p class="m_b10">以下の項目を入力して[確認画面へ]ボタンをクリックしてください。<span class="attention">＊</span>の項目は必須となります。</p>
    <form id="couponForm" name="couponForm" action= "{$smarty.const.KUJAPANURLSSL}/system/shop/base/barcode/input" method="post" enctype="multipart/form-data">
...
{if isset($shop_item.0.file_id)}
        ...
        <br />
        <input type="checkbox" name="delete_check">削除する
{/if}
    </div>
