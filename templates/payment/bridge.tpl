...
{include file="include/common/genre_box.inc"}
        ...
        <div id="s_main">
          <h2 class="list">{$locale.bridge_title}</h2>
            ...
            <span id="divide_format_span">{$locale.footer_rule}</span>
            <div id="divide_format_message">
            <ul class="indentbox">
...
{/foreach}
        ...
        <div id="form_btn">
        <a href="{$smarty.const.KUJAPANURLSSL}/payment/alipay" title="{$locale.buy_bt}"><img alt="" src="/locale/{$smarty.const.LOCALE}/img/button/alipay_btn.jpg" width="160" height="40" class="btn" /></a>
        </div>
